...
#+BEGIN_SRC elisp
  ...
  (defvar mm-indentation-settings
    '((c-mode :extra-vars (c-basic-offset))
      ...
      (emacs-lisp-mode :tabs nil)
      (lisp-mode :tabs nil)
      (org-mode :tabs nil)
      (python-mode :width 4 :tabs t :extra-vars (python-indent-offset))
      (rust-mode :width 4 :tabs t)
      (sgml-mode :width 4 :tabs t :extra-vars (sgml-basic-offset))
  ...
  (defun mm-set-indentation-settings ()
    ...
    (mm-for-each mm-indentation-settings
      (let* ((mode (car x))
	     ...
	     (tabs (or (plist-get args :tabs) (default-value 'indent-tabs-mode)))
