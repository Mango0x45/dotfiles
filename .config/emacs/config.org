    ...
    (setq mm--mu4e-personal-context
          (make-mu4e-context
           ...
           :vars '((user-mail-address  . "mail@thomasvoss.com")
                   ...
                   (mu4e-maildir-shortcuts . '(("/mail@thomasvoss.com/Inbox"   . ?i)
                                               ("/mail@thomasvoss.com/Sent"    . ?s)
                                               ("/mail@thomasvoss.com/Archive" . ?a)
                                               ("/mail@thomasvoss.com/Drafts"  . ?d)
                                               ("/mail@thomasvoss.com/Junk"    . ?j))))))
